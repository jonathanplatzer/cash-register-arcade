...
State.OptionMenu.prototype = {
    ...
    create: function() {
        this.button_theme=this.game.add.button(this.game.width/10,this.game.height/10,'button_theme',this.toggleTheme);
        this.button_theme.width=this.game.width/10*8;
        this.button_theme.height=this.game.height/5;
        this.button_music=this.game.add.button(this.game.width/10,this.game.height/10*4,'button_music',this.toggleMusic);
        this.button_music.width=this.game.width/10*8;
        this.button_music.height=this.game.height/5;
        this.button_sound=this.game.add.button(this.game.width/10,this.game.height/10*7,'button_sound',this.toggleSfx);
        this.button_sound.width=this.game.width/10*8;
        this.button_sound.height=this.game.height/5;
    },
    update: function() {},
